  ...
  return (
    <div className="patient-highlight glass-lite">
      ...
      <div className="ph-left">
        ...
        <div>
          <h2>{patient.name}</h2>
          <p className="muted">DNI {patient.dni} · Tel: {patient.phone || "—"}</p>
        </div>
      </div>
      ...
      <div className="ph-med">
        <div className="ph-line">
          <strong>Alergias:</strong> <em>{patient.allergies || "Sin alergias registradas"}</em>
        </div>
        <div className="ph-line">
          <strong>Enfermedades crónicas:</strong> <em>{patient.chronic || "Ninguna registrada"}</em>
        </div>
        <div className="ph-line">
          <strong>Contacto de emergencia:</strong> <em>
